...
export default function OnboardingPage() {
  ...
  const [connected, setConnected] = useState<ChannelId | null>("instagram");
      ...
      <div className="w-full max-w-lg glass rounded-3xl p-8">
        ...
        {step === 0 && (
          <>
            ...
            <div className="mt-6 space-y-2">
              ...
              <Input id="ws" defaultValue="Bloom & Co." />
            </div>
        ...
        {step === 2 && (
          <>
            ...
            <p className="mt-1 text-sm text-muted-foreground">Mock OAuth — nothing leaves this browser.</p>
